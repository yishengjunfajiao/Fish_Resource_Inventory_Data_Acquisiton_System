...
public class CreateSQLs {
    ...
    public static final String MONITORING_SITE = new StringBuffer()
            ...
            .append("Institution VARCHAR(60),")
            .append("Investigator     VARCHAR(40),")
            .append("InvestigationDate SMALLDATETIME,")
            .append("Site VARCHAR(200),")
            .append("River VARCHAR(20),")
            .append("Photo TEXT,")
