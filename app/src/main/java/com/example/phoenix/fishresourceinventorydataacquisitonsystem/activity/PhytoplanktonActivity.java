 ...
 * 维护 浮游植物 界面
 * */
public class PhytoplanktonActivity extends AppCompatActivity implements View.OnClickListener{
    //新增优势种
    ...
    private void init(){
        ...
        addDominantSpecies = (GridLayout) findViewById(R.id.phy_add_dom_spe);
        addDominantSpeciesView = LayoutInflater.from(PhytoplanktonActivity.this)
        ...
        addPic = (GridLayout) findViewById(R.id.phy_add_pic);
        addPicView = LayoutInflater.from(PhytoplanktonActivity.this)
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.add_dom_spe:
                ...
                startActivityForResult(new Intent(PhytoplanktonActivity.this,
                        DominantSpeciesActivity.class), ConstantData.DOMINANTSPECIES_SUCCESSFUL);
                break;
            case R.id.add_pic:

                Toast.makeText(PhytoplanktonActivity.this, "照片", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.ensure:
                ...
                setResult(ConstantData.PHYTOPLANKTON_SUCCESSFUL,intent);
                finish();
                break;
        }
    }
