    ...
    public class Builder {
        ...
        public BaseNode build() throws IncompleteFieldException {
            if (SampleID == null) {
                ...
                error.append("Table ").append(TableNames.PHYTOPLANKTON).append(" : ")
            ...
            phytoplankton.SampleID = this.SampleID;
            phytoplankton.Photo = this.Photo;
            phytoplankton.Quality = this.Quality;
            phytoplankton.Biomass = this.Biomass;
            phytoplankton.ID_FractureSurface = this.ID_FractureSurface;
